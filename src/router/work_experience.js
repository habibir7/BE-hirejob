...
router.post("/",Protect,upload.single('photo'), workExperienceController.inputWorkExperience);
router.put("/:id",Protect,upload.single('photo'), workExperienceController.updateWorkExperience);
