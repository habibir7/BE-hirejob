...
const getMessageByIdMessageDetailModel = async (id_messagedetail) => {
  ...
  return new Promise((resolve, reject) =>
    Koneksi.query(
      `SELECT * FROM message WHERE id_messagedetail='${id_messagedetail}' ORDER BY created_at DESC`,
      (err, res) => {
        if (!err) {
          return resolve(res);
        } else {
...
const createMessageModel = async (data) => {
  ...
  return new Promise((resolve, reject) =>
    Koneksi.query(
      `INSERT INTO message (id_message, id_messagedetail, message_value, id_user, created_at) VALUES ('${id_message}', '${id_messagedetail}', '${message_value}', '${id}' , NOW())`,
      (err, res) => {
        if (!err) {
          return resolve(res);
        } else {
...
const updateMessageModel = async (data) => {
  ...
  return new Promise((resolve, reject) =>
    Koneksi.query(
      `UPDATE message SET message_name='${message_name}' WHERE id_message='${id_message}'`,
      (err, res) => {
        if (!err) {
          return resolve(res);
        } else {
...
const deleteMessageModel = async (id_message) => {
  return new Promise((resolve, reject) =>
    Koneksi.query(
      `DELETE FROM message where id_message ='${id_message}'`,
      (err, res) => {
        if (!err) {
          return resolve(res);
        } else {
