...
const getProvinceByIdModel = async (id_province) => {
  ...
  return new Promise((resolve, reject) =>
    Koneksi.query(
      `SELECT * FROM province WHERE id_province='${id_province}'`,
      (err, res) => {
        if (!err) {
          return resolve(res);
        } else {
...
const createProvinceModel = async (data) => {
  ...
  return new Promise((resolve, reject) =>
    Koneksi.query(
      `INSERT INTO province (id_province, province_name) VALUES ('${id_province}', '${province_name}')`,
      (err, res) => {
        if (!err) {
          return resolve(res);
        } else {
...
const updateProvinceModel = async (data) => {
  ...
  return new Promise((resolve, reject) =>
    Koneksi.query(
      `UPDATE province SET province_name='${province_name}' WHERE id_province='${id_province}'`,
      (err, res) => {
        if (!err) {
          return resolve(res);
        } else {
...
const deleteProvinceModel = async (id_province) => {
  return new Promise((resolve, reject) =>
    Koneksi.query(
      `DELETE FROM province where id_province ='${id_province}'`,
      (err, res) => {
        if (!err) {
          return resolve(res);
        } else {
