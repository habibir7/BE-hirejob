...
const MessagedetailController = {
    getMessagedetailById: async(req,res,next) => {
        try{
            ...
            if(id_messagedetail === ""){
                return res.status(404).json({ messagedetail: "params id invalid" })
            }
            ...
            return res
                .status(200)
                .json({ message: "success getMessagedetailById", data: result[0] });
        }  catch (err) {
            return res
                .status(404)
        ...
        try {
            ...
            if(
                ...
                return res.json({code: 404,message: "Harap masukkan Messagedetail Dengan lengkap"})
            }
        ...
        try{
            ...
            return res.status(200).json({message:"sukses getMessagedetail ",data:result})
        }catch(err){
            return res.status(404).json({message:"gagal getMessagedetail controller"})
        }
    },
